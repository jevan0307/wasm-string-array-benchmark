...
StringLens.forEach((len) => {
	StringNums.forEach((num) => {
		...
		suite.add(`StringSplit(JSON): Len: ${len}, Num: ${num}`, () => {
...
StringLens.forEach((len) => {
	StringNums.forEach((num) => {
		let bigString = ("a".repeat(len) + "\n").repeat(num);
		suite.add(`StringSplit(Intermediate Object): Len: ${len}, Num: ${num}`, () => {
...
StringLens.forEach((len) => {
	StringNums.forEach((num) => {
		...
		suite.add(`StringCat(JSON): Len: ${len}, Num: ${num}`, () => {
...
StringLens.forEach((len) => {
	StringNums.forEach((num) => {
		let bigStringArray = Array(num).fill("a".repeat(len));
		suite.add(`StringCat(Intermediate Object): Len: ${len}, Num: ${num}`, () => {
